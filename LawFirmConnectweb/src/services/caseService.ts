...
const uploadDocument = async (id: string, formData: FormData): Promise<Document[]> => {
...
const deleteDocument = async (caseId: string, documentId: string): Promise<void> => {
...
const addCaseActivity = async (id: string, activityData: { description: string, type?: string }): Promise<ActivityLog[]> => {
...
const addCaseBilling = async (id: string, billingData: any): Promise<BillingRecord[]> => {
